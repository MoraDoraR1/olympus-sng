// 방어탑/성벽/자원보호소 역할 재설계(수성 전용) 검증 — combat.js의 순수 함수를 직접
// 호출해 공식이 game.js 클라이언트 미러와 정확히 같은 수치를 내는지 확인한다.
...
import { homeDefenseMultiplier, wallFlatDefense, shelterProtectedAmount } from "../src/lib/combat.js";
